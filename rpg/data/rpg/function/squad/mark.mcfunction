# 找到了。标记目标，全队转入交战。
execute as @e[distance=..2.0,type=!#rpg:sq_ignore,tag=!rpg.squad,tag=!rpg.merc,tag=!rpg.sq.board,tag=!rpg.doll,limit=1,sort=nearest] run function rpg:squad/mark_one
