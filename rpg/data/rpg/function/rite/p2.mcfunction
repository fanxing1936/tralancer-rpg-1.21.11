...
execute as @a[distance=..6] run scoreboard players remove @s rpg_taint 10
...
# 图腾随着燃尽一点点缩小
data merge entity @s {transformation:{translation:[0f,0.4f,0f],left_rotation:[0f,0f,0f,1f],scale:[0.88f,0.88f,0.88f],right_rotation:[0f,0f,0f,1f]}}
