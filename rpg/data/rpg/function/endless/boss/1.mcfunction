...
tellraw @a[tag=rpg.end.member.current,distance=..96] ["",{"text":"[领主降临] ","color":"#00491C","bold":true,"italic":false},{"text":"路西法 ","color":"#00491C","bold":false,"italic":false},{"text":"封锁本层出口。","color":"#AAB4C3","bold":false,"italic":false}]
