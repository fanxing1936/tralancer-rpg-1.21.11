# 第 25 号编队：撒布诺克 / 单卡拉比 / 贝雷特 / 亚斯塔禄 / 富卡斯
...
execute if score #spawn rpg_end_tmp matches 3.. positioned ^0 ^0 ^16 run function rpg:minion/summon/abaddon/beleth
...
execute if score #spawn rpg_end_tmp matches 4.. positioned ^-12 ^0 ^18 run function rpg:minion/summon/belial/astaroth
...
execute if score #spawn rpg_end_tmp matches 5.. positioned ^12 ^0 ^18 run function rpg:endless/summon/furcas
