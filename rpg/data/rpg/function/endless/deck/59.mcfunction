# 第 59 号编队：锡蒙利 / 亚蒙 / 比弗隆斯 / 欧利亚斯 / 马尔巴士
tag @e[tag=rpg.demon.minion] add rpg.end.preexisting
execute if score #spawn rpg_end_tmp matches 1.. positioned ^-8 ^0 ^12 run function rpg:endless/summon/cimejes
...
execute if score #spawn rpg_end_tmp matches 2.. positioned ^8 ^0 ^12 run function rpg:minion/summon/leviathan/amon
