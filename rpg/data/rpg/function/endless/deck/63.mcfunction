# 第 63 号编队：古辛 / 罗诺比 / 阿米 / 派蒙 / 格拉夏·拉波拉斯
tag @e[tag=rpg.demon.minion] add rpg.end.preexisting
execute if score #spawn rpg_end_tmp matches 1.. positioned ^-8 ^0 ^12 run function rpg:minion/summon/abaddon/gusion
...
execute if score #spawn rpg_end_tmp matches 2.. positioned ^8 ^0 ^12 run function rpg:minion/summon/belial/ronove
