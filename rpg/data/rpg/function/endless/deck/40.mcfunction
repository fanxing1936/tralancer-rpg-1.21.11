# 第 40 号编队：撒布诺克 / 单卡拉比 / 巴钦 / 佛尔佛尔 / 巴拉姆
...
execute if score #spawn rpg_end_tmp matches 3.. positioned ^0 ^0 ^16 run function rpg:minion/summon/beelzebub/bathin
...
execute if score #spawn rpg_end_tmp matches 4.. positioned ^-12 ^0 ^18 run function rpg:minion/summon/mammon/furfur
...
execute if score #spawn rpg_end_tmp matches 5.. positioned ^12 ^0 ^18 run function rpg:endless/summon/balam
