# 第 31 号编队：巴力 / 布提斯 / 比弗隆斯 / 欧利亚斯 / 马尔巴士
tag @e[tag=rpg.demon.minion] add rpg.end.preexisting
execute if score #spawn rpg_end_tmp matches 1.. positioned ^-8 ^0 ^12 run function rpg:minion/summon/lucifer/bael
...
execute if score #spawn rpg_end_tmp matches 2.. positioned ^8 ^0 ^12 run function rpg:minion/summon/beelzebub/botis
