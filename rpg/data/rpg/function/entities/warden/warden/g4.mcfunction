# 15 行原本各自扫一遍全实体表找 @e[type=minecraft:vindicator,tag=devil2,tag=boss]；现在由上层一次判定后统一进入。
# 行内容与顺序原样保留。
...
execute as @e[type=minecraft:vindicator,tag=devil2,tag=boss] at @s if score @s devil matches 250 as @a[distance=..10] at @s run summon minecraft:creeper ~ ~ ~ {"ExplosionRadius":3,ignited:1b}
...
execute as @e[type=minecraft:vindicator,tag=devil2,tag=boss] at @s if score @s devil matches 390 run execute as @e[type=minecraft:vindicator,tag=devil2,tag=tick] at @s run summon minecraft:creeper ~ ~ ~ {"ExplosionRadius":4,ignited:1b}
execute as @e[type=minecraft:vindicator,tag=devil2,tag=boss] at @s if score @s devil matches 390 run execute as @e[type=minecraft:vindicator,tag=devil2,tag=tick] at @s run particle squid_ink ~1 ~1 ~1 -2 -1 -2 1 100 
execute as @e[type=minecraft:vindicator,tag=devil2,tag=boss] at @s if score @s devil matches 390 run execute as @e[type=minecraft:vindicator,tag=devil2,tag=tick] at @s run kill
execute as @e[type=minecraft:vindicator,tag=devil2,tag=boss] at @s if score @s devil matches 390 run summon vindicator ~2 ~ ~ {Johnny:1,Health:100,Tags:["devil2","tick"],attributes:[{id:"max_health",base:100f}],equipment:{mainhand:{id:netherite_sword,components:{custom_model_data:{floats:[1110007.0f]}},count:1}},drop_chances:{mainhand:0f}}
execute as @e[type=minecraft:vindicator,tag=devil2,tag=boss] at @s if score @s devil matches 390 run summon vindicator ~-2 ~ ~ {Johnny:1,Health:100,Tags:["devil2","tick"],attributes:[{id:"max_health",base:100f}],equipment:{mainhand:{id:netherite_sword,components:{custom_model_data:{floats:[1110007.0f]}},count:1}},drop_chances:{mainhand:0f}}
execute as @e[type=minecraft:vindicator,tag=devil2,tag=boss] at @s if score @s devil matches 390 run summon vindicator ~ ~ ~2 {Johnny:1,Health:100,Tags:["devil2","tick"],attributes:[{id:"max_health",base:100f}],equipment:{mainhand:{id:netherite_sword,components:{custom_model_data:{floats:[1110007.0f]}},count:1}},drop_chances:{mainhand:0f}}
execute as @e[type=minecraft:vindicator,tag=devil2,tag=boss] at @s if score @s devil matches 390 run summon vindicator ~ ~ ~-2 {Johnny:1,Health:100,Tags:["devil2","tick"],attributes:[{id:"max_health",base:100f}],equipment:{mainhand:{id:netherite_sword,components:{custom_model_data:{floats:[1110007.0f]}},count:1}},drop_chances:{mainhand:0f}}
