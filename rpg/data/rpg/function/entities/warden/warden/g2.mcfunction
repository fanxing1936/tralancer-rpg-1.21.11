...
execute as @e[tag=devil,tag=boss] at @s if score @s devil matches 50 if entity @a[distance=..5] run execute positioned ~ ~1 ~ run function rpg:effect/pseudo_explosion/owned_p8
