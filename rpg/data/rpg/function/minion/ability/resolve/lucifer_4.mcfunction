...
effect give @a[distance=..8,gamemode=!spectator,gamemode=!creative] minecraft:weakness 3 0 true
effect give @a[distance=..8,gamemode=!spectator,gamemode=!creative] minecraft:mining_fatigue 4 0 true
execute as @a[distance=..8,gamemode=!spectator,gamemode=!creative] run damage @s 1 minecraft:magic by @e[tag=rpg.demon.minion.caster,distance=..10,sort=nearest,limit=1]
