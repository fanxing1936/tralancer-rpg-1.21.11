...
execute as @a[distance=..4,gamemode=!spectator,gamemode=!creative] run damage @s 9 minecraft:magic by @e[tag=rpg.demon.minion.caster,distance=..8,limit=1]
