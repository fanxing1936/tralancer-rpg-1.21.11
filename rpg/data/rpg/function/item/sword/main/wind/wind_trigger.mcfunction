execute as @a[scores={wind=50..}] anchored feet at @s run summon armor_stand ^ ^ ^2 {Invisible:1b,CustomName:[{"text":"wind_atk"}],Invulnerable:1b}
execute as @a[scores={wind=50..}] anchored eyes at @s run playsound minecraft:entity.breeze.wind_burst player @s
execute as @e[name=wind_atk,type=armor_stand] at @s run tp @s ~ ~ ~ facing entity @p[scores={wind=50..}]
execute as @a[scores={wind=50..}] anchored eyes at @s run scoreboard players set @s wind 0
