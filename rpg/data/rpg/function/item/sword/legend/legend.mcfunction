...
execute as @e at @s on attacker if entity @s[scores={saber=0..,random=1},tag=rpg.h.saber_tag1] run summon minecraft:tnt ~ ~ ~ {fuse:0s,explosion_power:2.0f}
...
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=4},tag=rpg.h.sakura_tag1] run summon minecraft:tnt ~ ~ ~ {fuse:0s,explosion_power:1.0f,Silent:1b}
...
execute as @e[type=minecraft:spectral_arrow,tag=sakura_tag] at @s unless block ~ ~-0.1 ~ air run summon minecraft:tnt ~ ~ ~ {fuse:0s,explosion_power:3.0f,Silent:1b}
...
execute as @e[type=minecraft:spectral_arrow,tag=sakura_tag] at @s if entity @e[distance=0.2..0.4] run summon minecraft:tnt ~ ~ ~ {fuse:0s,explosion_power:3.0f,Silent:1b}
