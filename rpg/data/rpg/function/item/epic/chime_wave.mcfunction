...
execute as @e[distance=0.1..3,type=!player,type=!minecraft:item,type=!minecraft:experience_orb] at @s run damage @s 3 minecraft:magic by @a[tag=rpg.epic.chime,limit=1,sort=nearest,distance=..8]
