...
execute unless entity @a[tag=rpg.levi.airborne,distance=..24] run scoreboard players set @e[tag=rpg.levi.new] rpg_levi_time 100
execute if entity @a[tag=rpg.levi.airborne,distance=..24] run scoreboard players set @e[tag=rpg.levi.new] rpg_levi_time 160
scoreboard players set @e[tag=rpg.levi.new] rpg_levi_beat 10
