...
execute as @e[distance=..7,type=!player,type=!minecraft:item,type=!minecraft:experience_orb,type=!minecraft:marker] at @s run particle dust_color_transition{from_color:8374496,to_color:532802,scale:2} ~ ~1 ~ 0.3 0.5 0.3 0.05 10
