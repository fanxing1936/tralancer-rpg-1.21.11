...
particle dust_color_transition{from_color:532802,to_color:1195644,scale:2} ~ ~0.3 ~ 3.5 0.25 3.5 0.02 26
particle bubble_column_up ~ ~ ~ 0.8 0.1 0.8 0.03 6
particle dust_color_transition{from_color:1195644,to_color:16559622,scale:1} ~ ~1.4 ~ 0.2 0.5 0.2 0.02 4
