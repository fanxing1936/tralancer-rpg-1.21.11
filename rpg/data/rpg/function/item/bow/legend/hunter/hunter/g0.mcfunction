...
execute as @e[tag=hunter] at @s if entity @e[distance=0.1..2] unless entity @a[tag=rpg.h.hunter_tag1,distance=..2] run summon minecraft:creeper ~ ~1 ~ {"ExplosionRadius":3,ignited:1b}
