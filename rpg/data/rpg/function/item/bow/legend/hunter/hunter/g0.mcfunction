...
execute as @e[tag=hunter] at @s if entity @e[distance=0.1..2] unless entity @a[tag=rpg.h.hunter_tag1,distance=..2] run summon minecraft:tnt ~ ~1 ~ {fuse:0s,explosion_power:3.0f}
