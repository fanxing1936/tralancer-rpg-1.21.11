...
execute as @e[type=minecraft:spectral_arrow,tag=burn_tag] at @s run particle flame ~0.1 ~0.1 ~0.1 -0.2 -0.2 -0.2 0.2 10 force
execute if entity @e[tag=burn] run function rpg:item/bow/legend/burn/burn/g0
execute if entity @e[type=minecraft:spectral_arrow,tag=burn_tag] run function rpg:item/bow/legend/burn/burn/g1
