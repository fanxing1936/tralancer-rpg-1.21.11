...
execute as @e[type=minecraft:marker,tag=rpg.ch1.controller,limit=1] if score @s rpg_ch1_id = @e[type=minecraft:item_display,tag=rpg.ch1.rite.active,limit=1] rpg_ch1_id run scoreboard players set @s rpg_ch1_choice 1
function rpg:campaign/beelzebub/ui/verdict/eliminate
