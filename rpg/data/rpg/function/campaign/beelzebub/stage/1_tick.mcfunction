...
execute if score @s rpg_ch1_obj matches 3.. if entity @s[tag=rpg.ch1.recap.anomaly] if score @s rpg_ch1_time matches 100.. run function rpg:campaign/beelzebub/advance
