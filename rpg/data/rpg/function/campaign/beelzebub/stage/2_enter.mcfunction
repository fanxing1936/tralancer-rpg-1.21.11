...
execute positioned ^ ^ ^19 run summon minecraft:villager ~ ~ ~ {Tags:["rpg.ch1.scene","rpg.ch1.vacant","rpg.ch1.vacant.safe","rpg.ch1.new","rpg.vac.seen","rpg.vacant"],NoAI:1b,Invulnerable:1b,PersistenceRequired:1b,Silent:1b,CustomName:["",{"text":"回家的母亲","color":"gray","bold":false,"italic":false}]}
