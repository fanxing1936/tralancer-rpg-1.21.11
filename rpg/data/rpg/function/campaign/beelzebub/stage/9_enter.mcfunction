...
execute positioned ^ ^ ^8 run summon minecraft:villager ~ ~ ~ {Tags:["rpg.ch1.scene","rpg.ch1.witness","rpg.ch1.new","rpg.vac.seen"],NoAI:1b,Invulnerable:1b,PersistenceRequired:1b,CustomName:["",{"text":"米拉 · 真实见证人","color":"#FFF2A8","bold":false,"italic":false}]}
