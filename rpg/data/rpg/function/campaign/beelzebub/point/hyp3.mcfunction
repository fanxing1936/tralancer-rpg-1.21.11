...
tellraw @a[tag=rpg.ch1.current,distance=..24] ["",{"text":"[调查] ","color":"#B8A98B","bold":true,"italic":false},{"text":"完好食物全部消失，毒马铃薯却被推出餐盘并留下逆向灼痕。","color":"gray","bold":false,"italic":false}]
tellraw @a[tag=rpg.ch1.current,distance=..24] ["",{"text":"伊莱亚：","color":"#D4AF37","bold":true,"italic":false},{"text":"人为盗粮解释不了拒食规律；腐败物能让仪式短暂失去胃口。","color":"gray","bold":false,"italic":false}]
