...
tellraw @a[tag=rpg.ch1.current,distance=..24] ["",{"text":"[调查] ","color":"#B8A98B","bold":true,"italic":false},{"text":"观察：面包仍温热，切面却是灰；她准确说出孩子生日。","color":"gray","bold":false,"italic":false}]
tellraw @a[tag=rpg.ch1.current,distance=..24] ["",{"text":"伊莱亚：","color":"#D4AF37","bold":true,"italic":false},{"text":"若是亡灵，她为何保留全部记忆？若仍活着，她为何不回应哭声？","color":"gray","bold":false,"italic":false}]
