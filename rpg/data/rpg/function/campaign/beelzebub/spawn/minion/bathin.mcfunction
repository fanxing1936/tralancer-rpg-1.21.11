tag @e[type=minecraft:evoker,tag=rpg.demon.minion.lord4,scores={rpg_mn_role=3},distance=..4] add rpg.ch1.preexisting
function rpg:minion/summon/beelzebub/bathin
tag @e[type=minecraft:evoker,tag=rpg.demon.minion.lord4,tag=!rpg.ch1.preexisting,scores={rpg_mn_role=3},distance=..4,sort=nearest,limit=1] add rpg.ch1.minion.new
scoreboard players operation @e[tag=rpg.ch1.minion.new,limit=1] rpg_ch1_id = @s rpg_ch1_id
data modify entity @e[tag=rpg.ch1.minion.new,limit=1] CustomName set value ["",{"text":"巴钦","color":"#B5D957","bold":true,"italic":false}]
