execute positioned ^ ^ ^36 run summon minecraft:marker ~ ~ ~ {Tags:["rpg.ch1.scene","rpg.ch1.point","rpg.ch1.trail4","rpg.ch1.new"]}
...
execute positioned ^ ^ ^36 run summon minecraft:text_display ~ ~1.15 ~ {Tags:["rpg.ch1.scene","rpg.ch1.label","rpg.ch1.trail4.label","rpg.ch1.new"],billboard:"center",see_through:0b,shadow:1b,background:0,view_range:0.30f,text:"[\"\",{\"text\":\"腐蝇痕迹 4 / 4\",\"color\":\"#B5D957\",\"bold\":true,\"italic\":false}]"}
...
function rpg:campaign/beelzebub/ui/scene/trail4
