...
execute positioned ^ ^ ^36 run summon minecraft:text_display ~ ~1.15 ~ {Tags:["rpg.ch1.scene","rpg.ch1.label","rpg.ch1.trail4.label","rpg.ch1.new"],billboard:"center",see_through:0b,shadow:1b,background:0,view_range:0.3f,text:["",{"text":"第七粮仓封条 · 丁","color":"#B5D957","bold":true,"italic":false}]}
