...
execute as @e[type=minecraft:marker,tag=rpg.ch1.controller,distance=..96,sort=nearest,limit=1] at @s run function rpg:campaign/beelzebub/debug/spawn_all_minions_worker
