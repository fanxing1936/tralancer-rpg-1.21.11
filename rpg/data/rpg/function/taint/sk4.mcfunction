...
execute if score #pick rpg_fall matches 4 run return run function rpg:taint/sk4_4
execute if score #pick rpg_fall matches 5 run return run function rpg:taint/sk4_5
