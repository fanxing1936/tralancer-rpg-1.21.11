function rpg:inquest/tool/place/medium7
...
clear @a[tag=rpg.rite.user,distance=..6,limit=1] minecraft:paper[minecraft:custom_data~{rpg_medium:7b}] 1
...
tellraw @a[distance=..16,gamemode=!spectator] ["",{"text":"[弱点媒介] ","color":"#B7950B","italic":false,"bold":true},{"text":"金锭 · 自愿之金已布入法阵。","color":"gray","italic":false}]
