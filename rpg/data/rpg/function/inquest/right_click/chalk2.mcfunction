function rpg:inquest/tool/place/chalk2
tag @s add rpg.layout.suppress
...
clear @a[tag=rpg.rite.user,distance=..6,limit=1] minecraft:paper[minecraft:custom_data~{rpg_chalk:2b}] 1
