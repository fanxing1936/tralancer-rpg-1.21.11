function rpg:inquest/tool/place/chalk1
tag @s add rpg.layout.guard
...
clear @a[tag=rpg.rite.user,distance=..6,limit=1] minecraft:paper[minecraft:custom_data~{rpg_chalk:1b}] 1
