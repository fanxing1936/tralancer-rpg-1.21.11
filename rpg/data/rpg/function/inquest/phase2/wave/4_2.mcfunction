...
execute if score @s rpg_ex_wave matches 12 run particle infested ~ ~1.1 ~ 14 1.6 14 0.08 94 force
execute if score @s rpg_ex_wave matches 12 run particle mycelium ~ ~1.5 ~ 9 1.0 9 0.035 42 force
execute if score @s rpg_ex_wave matches 12 as @a[distance=4.01..24,gamemode=!spectator,gamemode=!creative] at @s run particle item_slime ~ ~1 ~ 0.42 0.65 0.42 0.05 14 force
...
execute if score @s rpg_ex_wave matches 1 run particle infested ~ ~1.3 ~ 18 2.2 18 0.10 126 force
execute if score @s rpg_ex_wave matches 1 run particle ash ~ ~1.4 ~ 12 1.4 12 0.06 62 force
execute if score @s rpg_ex_wave matches 1 as @a[distance=4.01..24,gamemode=!spectator,gamemode=!creative] at @s run particle item_slime ~ ~1 ~ 0.68 0.9 0.68 0.07 20 force
