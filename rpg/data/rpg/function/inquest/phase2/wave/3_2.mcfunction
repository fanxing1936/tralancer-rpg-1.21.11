...
execute if score @s rpg_ex_wave matches 12 run particle sculk_soul ~ ~1.1 ~ 14 1.6 14 0.08 94 force
...
execute if score @s rpg_ex_wave matches 1 run particle sculk_soul ~ ~1.3 ~ 18 2.2 18 0.10 126 force
