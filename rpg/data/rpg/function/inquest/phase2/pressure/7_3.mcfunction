...
scoreboard players set @s rpg_ex_wave_kind 73
...
particle totem_of_undying ~ ~1.15 ~ 12 1.8 12 0.07 138 force
particle end_rod ~ ~1.55 ~ 8 1.2 8 0.045 58 force
tellraw @a[distance=..24,gamemode=!spectator] ["",{"text":"[罪域·玛门] ","color":"#B7950B","italic":false,"bold":true},{"text":"什一血税 · 三重罪域爆发，退入法阵四格庇护圈。","color":"gray","italic":false}]
execute as @a[distance=4.01..24,gamemode=!spectator,gamemode=!creative] at @s run particle totem_of_undying ~ ~1 ~ 0.65 0.95 0.65 0.06 22 force
...
playsound minecraft:block.amethyst_block.resonate hostile @a[distance=..32] ~ ~ ~ 0.95 0.96
