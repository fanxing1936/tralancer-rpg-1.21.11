...
scoreboard players set @s rpg_ex_wave_kind 63
...
particle portal ~ ~1.15 ~ 12 1.8 12 0.07 138 force
particle reverse_portal ~ ~1.55 ~ 8 1.2 8 0.045 58 force
tellraw @a[distance=..24,gamemode=!spectator] ["",{"text":"[罪域·贝利尔] ","color":"#5B2C6F","italic":false,"bold":true},{"text":"欲障迷宫 · 三重罪域爆发，退入法阵四格庇护圈。","color":"gray","italic":false}]
execute as @a[distance=4.01..24,gamemode=!spectator,gamemode=!creative] at @s run particle portal ~ ~1 ~ 0.65 0.95 0.65 0.06 22 force
execute as @a[distance=4.01..24,gamemode=!spectator,gamemode=!creative] at @s run particle heart ~ ~1 ~ 0.38 0.60 0.38 0.04 12 force
execute as @a[distance=4.01..24,gamemode=!spectator,gamemode=!creative] run damage @s 10 minecraft:magic
playsound minecraft:entity.illusioner.prepare_mirror hostile @a[distance=..32] ~ ~ ~ 0.95 0.96
...
effect give @a[distance=4.01..24,gamemode=!spectator,gamemode=!creative] minecraft:nausea 8 0 true
