...
scoreboard players set @s rpg_ex_wave_kind 32
...
particle sculk_soul ~ ~1.15 ~ 12 1.8 12 0.07 138 force
particle soul ~ ~1.55 ~ 8 1.2 8 0.045 58 force
tellraw @a[distance=..24,gamemode=!spectator] ["",{"text":"[罪域·亚巴顿] ","color":"#6A6A70","italic":false,"bold":true},{"text":"死寂收割 · 三重罪域爆发，退入法阵四格庇护圈。","color":"gray","italic":false}]
execute as @a[distance=4.01..24,gamemode=!spectator,gamemode=!creative] at @s run particle sculk_soul ~ ~1 ~ 0.65 0.95 0.65 0.06 22 force
...
playsound minecraft:entity.warden.sonic_boom hostile @a[distance=..32] ~ ~ ~ 0.95 0.88
effect give @a[distance=4.01..24,gamemode=!spectator,gamemode=!creative] minecraft:wither 6 0 true
