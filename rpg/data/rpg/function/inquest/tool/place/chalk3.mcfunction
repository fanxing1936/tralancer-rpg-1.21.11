...
summon minecraft:item_display ~ ~0.06 ~ {Tags:["rpg.rite.prop","rpg.rite.prop.new","rpg.rite.prop.chalk3"],item:{id:"minecraft:light_blue_dye",count:1,components:{"minecraft:enchantment_glint_override":1b}},item_display:"ground",view_range:0.65f,shadow_radius:0.18f,shadow_strength:0.45f,brightness:{block:15,sky:12},transformation:{translation:[0f,0.03f,0f],scale:[0.86f,0.86f,0.86f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]}}
