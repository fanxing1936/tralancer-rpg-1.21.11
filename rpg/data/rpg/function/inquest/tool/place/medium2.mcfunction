...
summon minecraft:item_display ~1.15 ~0.06 ~0.75 {Tags:["rpg.rite.prop","rpg.rite.prop.new","rpg.rite.prop.medium"],item:{id:"minecraft:prismarine_crystals",count:1,components:{"minecraft:enchantment_glint_override":1b}},item_display:"ground",view_range:0.65f,shadow_radius:0.18f,shadow_strength:0.45f,brightness:{block:15,sky:12},transformation:{translation:[0f,0.03f,0f],scale:[0.84f,0.84f,0.84f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]}}
