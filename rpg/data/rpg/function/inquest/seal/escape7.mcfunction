clear @s minecraft:echo_shard[minecraft:food={nutrition:0,saturation:0f,can_always_eat:1b},minecraft:consumable={consume_seconds:100160f,animation:"block",sound:"minecraft:block.respawn_anchor.ambient",has_consume_particles:false,on_consume_effects:[]},minecraft:max_stack_size=1,minecraft:custom_data~{rpg_sealed:1b,rpg_lord:7}] 1
