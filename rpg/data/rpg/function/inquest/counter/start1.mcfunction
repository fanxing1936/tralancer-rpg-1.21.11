...
summon minecraft:armor_stand ~-2 ~ ~ {Tags:["rpg.counter.name","rpg.counter.true"],Invisible:1b,NoGravity:1b,PersistenceRequired:1b,CustomNameVisible:1b,CustomName:[{"text":"路西法","color":"#00491C","bold":false,"italic":false}],Health:200f,attributes:[{id:"max_health",base:200f}]}
