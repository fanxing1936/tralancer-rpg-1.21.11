...
tellraw @s ["",{"text":"[罪证] ","color":"#DAA520","bold":true,"italic":false},{"text":"路西法 · ","color":"#00491C","bold":true,"italic":false},{"text":"以一枚轻羽代替王冠，能使傲慢接受宣判。","color":"gray","italic":false},{"text":"　进度 ","color":"dark_gray","italic":false},{"score":{"name":"@s","objective":"rpg_case1"},"color":"white","italic":false},{"text":"/3","color":"dark_gray","italic":false}]
