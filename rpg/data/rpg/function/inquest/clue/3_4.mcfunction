...
tellraw @s ["",{"text":"[罪证] ","color":"#DAA520","bold":true,"italic":false},{"text":"亚巴顿 · ","color":"#6A6A70","bold":false,"italic":false},{"text":"停摆是怠惰最纯粹的愿望：让时间替它放弃。","color":"gray","italic":false},{"text":"　进度 ","color":"dark_gray","italic":false},{"score":{"name":"@s","objective":"rpg_case3"},"color":"white","italic":false},{"text":"/3","color":"dark_gray","italic":false}]
