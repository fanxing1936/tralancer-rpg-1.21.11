...
tellraw @s ["",{"text":"[罪证] ","color":"#DAA520","bold":true,"italic":false},{"text":"贝利尔 · ","color":"#5B2C6F","bold":true,"italic":false},{"text":"朝拜强迫身体低头，却不能证明心已屈服。","color":"gray","italic":false},{"text":"　进度 ","color":"dark_gray","italic":false},{"score":{"name":"@s","objective":"rpg_case6"},"color":"white","italic":false},{"text":"/3","color":"dark_gray","italic":false}]
