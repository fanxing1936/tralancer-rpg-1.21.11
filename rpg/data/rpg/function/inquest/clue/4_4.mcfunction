...
tellraw @s ["",{"text":"[罪证] ","color":"#DAA520","bold":true,"italic":false},{"text":"别西卜 · ","color":"#5A6B1E","bold":true,"italic":false},{"text":"腐宴把宾客也算作菜肴，却惧怕已经坏死的食物。","color":"gray","italic":false},{"text":"　进度 ","color":"dark_gray","italic":false},{"score":{"name":"@s","objective":"rpg_case4"},"color":"white","italic":false},{"text":"/3","color":"dark_gray","italic":false}]
