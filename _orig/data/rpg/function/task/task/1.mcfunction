...
execute as @s[scores={task=2}] at @s run summon vindicator ~8 ~ ~6 {Johnny:1,HandItems:[{id:netherite_sword,components:{custom_model_data:1110008},count:1}],ArmorItems:[{},{},{},{id:wither_skeleton_skull,components:{enchantments:{levels:{knockback:1}}},count:1}],HandDropChances:[0f],ArmorDropChances:[0f,0f,0f,0f],Tags:["dev"]}
execute as @s[scores={task=2}] at @s run summon vindicator ~-9 ~ ~7 {Johnny:1,HandItems:[{id:netherite_sword,components:{custom_model_data:1110008},count:1}],ArmorItems:[{},{},{},{id:wither_skeleton_skull,components:{enchantments:{levels:{knockback:1}}},count:1}],HandDropChances:[0f],ArmorDropChances:[0f,0f,0f,0f],Tags:["dev"]}
execute as @s[scores={task=2}] at @s run summon vindicator ~-8 ~ ~-6 {Johnny:1,HandItems:[{id:netherite_sword,components:{custom_model_data:1110008},count:1}],ArmorItems:[{},{},{},{id:wither_skeleton_skull,components:{enchantments:{levels:{knockback:1}}},count:1}],HandDropChances:[0f],ArmorDropChances:[0f,0f,0f,0f],Tags:["dev"]}
execute as @s[scores={task=2}] at @s run summon vindicator ~7 ~ ~-10 {Johnny:1,HandItems:[{id:netherite_sword,components:{custom_model_data:1110008},count:1}],ArmorItems:[{},{},{},{id:wither_skeleton_skull,components:{enchantments:{levels:{knockback:1}}},count:1}],HandDropChances:[0f],ArmorDropChances:[0f,0f,0f,0f],Tags:["dev"]}
execute as @s[scores={task=2}] at @s run summon vindicator ~8 ~ ~-6 {Johnny:1,HandItems:[{id:netherite_sword,components:{custom_model_data:1110008},count:1}],ArmorItems:[{},{},{},{id:wither_skeleton_skull,components:{enchantments:{levels:{knockback:1}}},count:1}],HandDropChances:[0f],ArmorDropChances:[0f,0f,0f,0f],Tags:["dev"]}
execute as @s[scores={task=2}] at @s run summon vindicator ~-9 ~ ~-7 {Johnny:1,HandItems:[{id:netherite_sword,components:{custom_model_data:1110008},count:1}],ArmorItems:[{},{},{},{id:wither_skeleton_skull,components:{enchantments:{levels:{knockback:1}}},count:1}],HandDropChances:[0f],ArmorDropChances:[0f,0f,0f,0f],Tags:["dev"]}
execute as @s[scores={task=2}] at @s run summon vindicator ~8 ~ ~5 {Johnny:1,HandItems:[{id:netherite_sword,components:{custom_model_data:1110008},count:1}],ArmorItems:[{},{},{},{id:wither_skeleton_skull,components:{enchantments:{levels:{knockback:1}}},count:1}],HandDropChances:[0f],ArmorDropChances:[0f,0f,0f,0f],Tags:["dev"]}
execute as @s[scores={task=2}] at @s run summon vindicator ~-5 ~ ~9 {Johnny:1,HandItems:[{id:netherite_sword,components:{custom_model_data:1110008},count:1}],ArmorItems:[{},{},{},{id:wither_skeleton_skull,components:{enchantments:{levels:{knockback:1}}},count:1}],HandDropChances:[0f],ArmorDropChances:[0f,0f,0f,0f],Tags:["dev"]}
execute as @s[scores={task=3}] at @s at @e[nbt={Tags:["dev"]},distance=..6] run summon lightning_bolt
execute as @s[scores={task=3}] at @s at @e[nbt={Tags:["dev"]},distance=..6] run particle sculk_soul ~0.25 ~1.2 ~0.25 -0.5 -1 -0.5 0.1 50
execute as @s[scores={task=3}] at @s as @e[nbt={Tags:["dev"]},distance=..6] at @s run kill 
