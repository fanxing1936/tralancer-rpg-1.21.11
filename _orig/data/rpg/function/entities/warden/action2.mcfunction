...
summon vindicator ~ ~ ~ {Johnny:1,Health:1000,Tags:["devil2","boss"],HandItems:[{id:netherite_sword,components:{custom_model_data:1110007},count:1},{id:netherite_sword,components:{custom_model_data:1110007},count:1}],ArmorItems:[{},{},{},{id:white_banner,components:{banner_patterns:[{pattern:rhombus,color:cyan},{pattern:stripe_bottom,color:light_gray},{pattern:stripe_center,color:gray},{pattern:half_horizontal,color:light_gray},{pattern:stripe_middle,color:black},{pattern:half_horizontal,color:light_gray},{pattern:circle,color:light_gray},{pattern:border,color:black}]},count:1}],HandDropChances:[0f,0f],ArmorDropChances:[0f,0f,0f,0f],attributes:[{id:"generic.max_health",base:1000f}]}
