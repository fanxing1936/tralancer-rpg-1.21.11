...
summon minecraft:evoker ~ ~ ~ {SpellTicks:0,Health:1000,Silent:1b,Tags:["devil","boss"],active_effects:[{id:speed,duration:-1,amplifier:1,show_particles:0b}],attributes:[{id:"generic.max_health",base:1000f},{id:"generic.armor",base:15f},{id:"generic.scale",base:1.2f},{id:"generic.knockback_resistance",base:0.5f}]}
