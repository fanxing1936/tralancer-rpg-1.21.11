##恶魔词缀
execute as @e at @s on attacker if entity @s[scores={devil_weapon=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{devil_weapon_tag:1b}}}}] run particle sculk_soul ~0.5 ~1.5 ~0.5 -1 -1 -1 0.2 10
execute as @e at @s on attacker if entity @s[scores={devil_weapon=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{devil_weapon_tag:1b}}}}] run particle soul_fire_flame ~0.5 ~1.5 ~0.5 -1 -1 -1 0.2 10

execute as @e at @s on attacker if entity @s[scores={devil_weapon=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{devil_weapon_tag:2b}}}}] run particle trial_spawner_detection_ominous ~0.5 ~1.5 ~0.5 -1 -1 -1 0.2 10
...
execute as @e at @s on attacker if entity @s[scores={devil_weapon=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{devil_weapon_tag:3b}}}}] run particle sculk_soul ~0.5 ~1.5 ~0.5 -1 -1 -1 0.2 10
execute as @e at @s on attacker if entity @s[scores={devil_weapon=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{devil_weapon_tag:3b}}}}] run particle trial_omen ~0.5 ~1.5 ~0.5 -1 -1 -1 0.2 10


scoreboard players reset * devil_weapon

##天使词缀
execute as @e at @s on attacker if entity @s[scores={holy=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{holy_weapon_tag:1b}}}}] run particle dust{color:[1.0,1.0,1.0],scale:3} ~0.5 ~1.5 ~0.5 -1 -1 -1 0.2 10
execute as @e at @s on attacker if entity @s[scores={holy=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{holy_weapon_tag:1b}}}}] run particle end_rod ~0.5 ~1.5 ~0.5 -1 -1 -1 0.2 10

execute as @e at @s on attacker if entity @s[scores={holy=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{holy_weapon_tag:2b}}}}] run particle firework ~0.5 ~1.5 ~0.5 -1 -1 -1 0.2 10
execute as @e at @s on attacker if entity @s[scores={holy=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{holy_weapon_tag:2b}}}}] run particle end_rod ~0.5 ~1.5 ~0.5 -1 -1 -1 0.2 10

execute as @e at @s on attacker if entity @s[scores={holy=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{holy_weapon_tag:3b}}}}] run particle totem_of_undying ~0.5 ~1.5 ~0.5 -1 -1 -1 0.2 10
execute as @e at @s on attacker if entity @s[scores={holy=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{holy_weapon_tag:3b}}}}] run particle dust{color:[1.0,0.78,0.0],scale:3} ~0.5 ~1.5 ~0.5 -1 -1 -1 0.2 10
...
execute as @e at @s on attacker if entity @s[scores={ashes=0..,ashes_level=5..},nbt={SelectedItem:{components:{"minecraft:custom_data":{ashes_tag:1b}}}}] run scoreboard players set @s ashes_level 1

execute as @e at @s on attacker if entity @s[scores={ashes=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{ashes_tag:1b}}}}] run effect give @e[distance=0..1] minecraft:wither 2 3 true
execute as @e at @s on attacker if entity @s[scores={ashes=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{ashes_tag:1b}}}}] run effect give @e[distance=0..1] minecraft:glowing 2 3 true
execute as @e at @s on attacker if entity @s[scores={ashes=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{ashes_tag:1b}}}}] run particle large_smoke ~0.5 ~1.5 ~0.5 -1 -1 -1 0.1 15

execute as @e at @s on attacker if entity @s[scores={ashes=0..,ashes_level=1},nbt={SelectedItem:{components:{"minecraft:custom_data":{ashes_tag:1b}}}}] run data merge entity @e[limit=1,sort=nearest] {Motion:[0d,0.5d,0d]}
execute as @e at @s on attacker if entity @s[scores={ashes=0..,ashes_level=1},nbt={SelectedItem:{components:{"minecraft:custom_data":{ashes_tag:1b}}}}] run particle dust_pillar{block_state:{Name:deepslate_coal_ore}} ~0.5 ~1.2 ~0.5 -1 -1 -1 1 10
execute as @e at @s on attacker if entity @s[scores={ashes=0..,ashes_level=1},nbt={SelectedItem:{components:{"minecraft:custom_data":{ashes_tag:1b}}}}] run playsound minecraft:item.mace.smash_air

execute as @e at @s on attacker if entity @s[scores={ashes=0..,ashes_level=2},nbt={SelectedItem:{components:{"minecraft:custom_data":{ashes_tag:1b}}}}] run particle minecraft:sweep_attack ~1 ~2 ~1 -2 -2 -2 1 20 
execute as @e at @s on attacker if entity @s[scores={ashes=0..,ashes_level=2},nbt={SelectedItem:{components:{"minecraft:custom_data":{ashes_tag:1b}}}}] run playsound minecraft:item.mace.smash_ground

execute as @e at @s on attacker if entity @s[scores={ashes=0..,ashes_level=3},nbt={SelectedItem:{components:{"minecraft:custom_data":{ashes_tag:1b}}}}] run particle squid_ink ~0.5 ~1.5 ~0.5 -1 -1 -1 0.1 30
execute as @e at @s on attacker if entity @s[scores={ashes=0..,ashes_level=3},nbt={SelectedItem:{components:{"minecraft:custom_data":{ashes_tag:1b}}}}] run playsound minecraft:item.mace.smash_ground_heavy

execute as @e at @s on attacker if entity @s[scores={ashes=0..,ashes_level=4},nbt={SelectedItem:{components:{"minecraft:custom_data":{ashes_tag:1b}}}}] run summon firework_rocket ~ ~1 ~ {Life:0,LifeTime:0,FireworksItem:{id:firework_rocket,components:{fireworks:{flight_duration:0,explosions:[{shape:burst,has_twinkle:1b,has_trail:1b,colors:[I;1908001,4673362,10329495,4673362,1908001]}]}}}}
execute as @e at @s on attacker if entity @s[scores={ashes=0..,ashes_level=4},nbt={SelectedItem:{components:{"minecraft:custom_data":{ashes_tag:1b}}}}] run effect give @s minecraft:wither 2 2 true 


execute as @e at @s on attacker if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{ashes_tag:1b}}}}] run particle large_smoke ~0.1 ~1.5 ~0.1 -0.2 -1 -0.2 0.2 1
execute as @e at @s on attacker if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{ashes_tag:1b}}}}] run tag @e[distance=0..2] add ashes
...
##贝利尔
execute as @e at @s on attacker if entity @s[scores={blil=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{blil_tag:1b}}}}] run effect give @e[distance=0..1] minecraft:wither 2 3 true
execute as @e at @s on attacker if entity @s[scores={blil=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{blil_tag:1b}}}}] run effect give @e[distance=0..1] minecraft:glowing 2 3 true
execute as @e at @s on attacker if entity @s[scores={blil=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{blil_tag:1b}}}}] run particle dust_color_transition{from_color:[0.4,0.0,0.6],scale:3,to_color:[0.0,0.0,0.0]} ~0.5 ~1.5 ~0.5 -1 -1 -1 0.1 30

execute as @e at @s on attacker if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{blil_tag:1b}}}}] run particle witch ~0.25 ~1.5 ~0.25 -0.5 -1 -0.5 0 2
...
execute as @e at @s on attacker if entity @s[scores={pen=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{pen_tag:1b}}}}] run particle squid_ink ~0.25 ~1.25 ~0.25 -0.5 -0.5 -0.5 0.2 20
...
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=5..},nbt={SelectedItem:{components:{"minecraft:custom_data":{sakura_tag:1b}}}}] run scoreboard players set @s sakura_step 1


execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=1},nbt={SelectedItem:{components:{"minecraft:custom_data":{sakura_tag:1b}}}}] run particle sweep_attack ~0.5 ~1.5 ~0.5 -1 -1 -1 1 20


execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=2},nbt={SelectedItem:{components:{"minecraft:custom_data":{sakura_tag:1b}}}}] run particle dust_pillar{block_state:{Name:cherry_leaves}} ~0.5 ~1.5 ~0.5 -1 -1 -1 1 20
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=2},nbt={SelectedItem:{components:{"minecraft:custom_data":{sakura_tag:1b}}}}] run effect give @e[distance=..0.1] minecraft:wind_charged 10 2 true


execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=3},nbt={SelectedItem:{components:{"minecraft:custom_data":{sakura_tag:1b}}}}] run particle dust_color_transition{from_color:[1.0,0.47,0.47],to_color:[1.0,1.0,1.0],scale:3} ~0.5 ~1.5 ~0.5 -1 -1 -1 1 20


execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=4},nbt={SelectedItem:{components:{"minecraft:custom_data":{sakura_tag:1b}}}}] run particle dust_color_transition{from_color:[1.0,0.47,0.47],to_color:[1.0,1.0,1.0],scale:3} ~0.5 ~1.5 ~0.5 -1 -1 -1 1 20
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=4},nbt={SelectedItem:{components:{"minecraft:custom_data":{sakura_tag:1b}}}}] run particle sweep_attack ~0.5 ~1.5 ~0.5 -1 -1 -1 1 20
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=4},nbt={SelectedItem:{components:{"minecraft:custom_data":{sakura_tag:1b}}}}] run summon minecraft:creeper ~ ~ ~ {Silent:1b,"ExplosionRadius":1,"Fuse":0}
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=4},nbt={SelectedItem:{components:{"minecraft:custom_data":{sakura_tag:1b}}}}] run summon minecraft:lightning_bolt
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=4},nbt={SelectedItem:{components:{"minecraft:custom_data":{sakura_tag:1b}}}}] run effect give @s minecraft:resistance 1 255 true
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=4},nbt={SelectedItem:{components:{"minecraft:custom_data":{sakura_tag:1b}}}}] run effect give @s minecraft:instant_health 1 3 true

execute as @e at @s on attacker if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{sakura_tag:1b}}}}] run particle cherry_leaves ~0.25 ~2.25 ~0.25 -0.5 -0.5 -0.5 1 5
execute as @e at @s on attacker if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{sakura_tag:1b}}}}] run damage @e[limit=1,sort=nearest] 2 minecraft:player_attack
execute as @e at @s on attacker if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{sakura_tag:1b}}}}] run effect give @e[limit=1,sort=nearest] minecraft:glowing 1 1 true

execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=1},nbt={SelectedItem:{components:{"minecraft:custom_data":{night_tag:1b}}}}] run particle dust_color_transition{from_color:[0.4,0.0,1.0],scale:1,to_color:[0.0,0.0,0.0],scale:3} ~0.5 ~0.5 ~0.5 -1 -1 -1 0.2 10
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=1},nbt={SelectedItem:{components:{"minecraft:custom_data":{night_tag:1b}}}}] run data merge entity @e[limit=1,sort=nearest] {Motion:[0d,1d,0d]}
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=1},nbt={SelectedItem:{components:{"minecraft:custom_data":{night_tag:1b}}}}] run scoreboard players set @s sakura_step 0


execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=2},nbt={SelectedItem:{components:{"minecraft:custom_data":{night_tag:1b}}}}] run particle enchant ~0.5 ~0.5 ~0.5 -1 -1 -1 0.2 100
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=2},nbt={SelectedItem:{components:{"minecraft:custom_data":{night_tag:1b}}}}] run effect give @e[limit=1,sort=nearest] minecraft:slowness 3 3 true
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=2},nbt={SelectedItem:{components:{"minecraft:custom_data":{night_tag:1b}}}}] run scoreboard players set @s sakura_step 0


execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=3},nbt={SelectedItem:{components:{"minecraft:custom_data":{night_tag:1b}}}}] run particle dust_pillar{block_state:{Name:purple_glazed_terracotta}} ~0.5 ~0.5 ~0.5 -1 -1 -1 0.2 100
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=3},nbt={SelectedItem:{components:{"minecraft:custom_data":{night_tag:1b}}}}] run effect give @s minecraft:instant_health 1 2 true
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=3},nbt={SelectedItem:{components:{"minecraft:custom_data":{night_tag:1b}}}}] run scoreboard players set @s sakura_step 0


execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=4},nbt={SelectedItem:{components:{"minecraft:custom_data":{night_tag:1b}}}}] run summon minecraft:spectral_arrow ~ ~10 ~ {Tags:["sakura_tag"]}
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=4},nbt={SelectedItem:{components:{"minecraft:custom_data":{night_tag:1b}}}}] run summon minecraft:spectral_arrow ~1 ~10 ~ {Tags:["sakura_tag"]}
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=4},nbt={SelectedItem:{components:{"minecraft:custom_data":{night_tag:1b}}}}] run summon minecraft:spectral_arrow ~ ~10 ~1 {Tags:["sakura_tag"]}
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=4},nbt={SelectedItem:{components:{"minecraft:custom_data":{night_tag:1b}}}}] run summon minecraft:spectral_arrow ~-1 ~10 ~ {Tags:["sakura_tag"]}
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=4},nbt={SelectedItem:{components:{"minecraft:custom_data":{night_tag:1b}}}}] run summon minecraft:spectral_arrow ~ ~10 ~-1 {Tags:["sakura_tag"]}
execute as @e at @s on attacker if entity @s[scores={sakura=0..,sakura_step=4},nbt={SelectedItem:{components:{"minecraft:custom_data":{night_tag:1b}}}}] run scoreboard players set @s sakura_step 0

execute as @e at @s on attacker if entity @s[scores={sakura=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{night_tag:1b}}},Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{sakura_tag:1b}}}]}] run particle sweep_attack ~0.5 ~1.5 ~0.5 -1 -1 -1 1 10
execute as @e at @s on attacker if entity @s[scores={sakura=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{night_tag:1b}}},Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{sakura_tag:1b}}}]}] run particle dust_color_transition{from_color:[0.4,0.0,1.0],scale:1,to_color:[0.0,0.0,0.0],scale:3} ~0.5 ~0.5 ~0.5 -1 -1 -1 0.2 10
...
##风
execute as @e at @s on attacker if entity @s[scores={typhoon=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{typhoon_tag:1b}}}}] run effect give @e[distance=0..2] minecraft:wind_charged 20 40 true
execute as @e at @s on attacker if entity @s[scores={typhoon=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{typhoon_tag:1b}}}}] run particle dust_color_transition{from_color:[0.53,0.78,0.37],to_color:[1.0,1.0,1.0],scale:3} ~1 ~2 ~1 -2 -2 -2 1 50
execute as @e at @s on attacker if entity @s[scores={typhoon=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{typhoon_tag:1b}}}}] run particle minecraft:gust_emitter_small ~0.5 ~1.2 ~0.5 -1 -1 -1 1 2
execute as @e at @s on attacker if entity @s[scores={typhoon=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{typhoon_tag:1b}}}}] run data merge entity @e[limit=1,sort=nearest] {Motion:[0d,0.8d,0d]}
...
execute as @e at @s on attacker if entity @s[scores={power=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{power_tag:1b}}}}] as @e[distance=0.1..2] at @s run damage @s 2 minecraft:player_attack 
...
##史诗武器
execute as @e at @s on attacker if entity @s[scores={sun=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{sun_tag:1b}}}}] run effect give @s minecraft:fire_resistance 2 3
execute as @e at @s on attacker if entity @s[scores={sun=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{sun_tag:1b}}}}] run particle dust_color_transition{from_color:[1.0,0.84,0.0],to_color:[1.0,0.64,0.0],scale:3} ~0.5 ~1.5 ~0.5 -1 -1 -1 0.1 30
scoreboard players reset * sun

execute as @e at @s on attacker if entity @s[scores={ice=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{ice_tag:1b}}}}] run effect give @e[distance=..1,limit=1] minecraft:slowness 2 255 true
execute as @e at @s on attacker if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{ice_tag:1b}}}}] run damage @e[distance=..1,limit=1] 1 freeze
execute as @e at @s on attacker if entity @s[scores={ice=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{ice_tag:1b}}}}] run particle dust_color_transition{from_color:[0.58,0.92,1.0],to_color:[1.0,1.0,1.0],scale:3} ~0.5 ~1.5 ~0.5 -1 -1 -1 0.1 30
scoreboard players reset * ice

execute as @e at @s on attacker if entity @s[scores={steel=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{steel_tag:1b}}}}] run effect give @s minecraft:resistance 2 0
execute as @e at @s on attacker if entity @s[scores={steel=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{steel_tag:1b}}}}] run particle dust_pillar{block_state:{Name:iron_block}} ~0.5 ~1.5 ~0.5 -1 -1 -1 0.1 30
scoreboard players reset * steel

execute as @e at @s on attacker if entity @s[scores={sea=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{sea_tag:1b}}}}] run effect give @e[distance=..1,limit=1] minecraft:wither 2 3 true
execute as @e at @s on attacker if entity @s[scores={sea=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{sea_tag:1b}}}}] run effect give @e[distance=..1,limit=1] minecraft:glowing 2 3 true
execute as @e at @s on attacker if entity @s[scores={sea=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{sea_tag:1b}}}}] run particle dust_color_transition{from_color:[1.0,0.38,0.92],to_color:[1.0,0.78,0.0],scale:3} ~0.5 ~1.5 ~0.5 -1 -1 -1 0.1 30
execute as @e at @s on attacker if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{sea_tag:1b}}}}] run particle raid_omen ~0.5 ~1.5 ~0.5 -1 -1 -1 0.1 3
...
execute as @e at @s on attacker if entity @s[scores={axe=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{axe_tag:1b}}}}] if data entity @s SelectedItem.components.minecraft:trim{"material":"minecraft:diamond"}.material run particle trial_spawner_detection_ominous ~0.2 ~1.2 ~0.2 -0.4 -0.4 -0.4 0 10
execute as @e at @s on attacker if entity @s[scores={axe=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{axe_tag:1b}}}}] if data entity @s SelectedItem.components.minecraft:trim{"material":"minecraft:diamond"}.material run effect give @e[distance=..1,limit=1] minecraft:slowness 2 2 true

execute as @e at @s on attacker if entity @s[scores={axe=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{axe_tag:1b}}}}] if data entity @s SelectedItem.components.minecraft:trim{"material":"minecraft:iron"}.material run particle dust_pillar{block_state:{Name:iron_block}} ~0.5 ~1.5 ~0.5 -1 -1 -1 0.1 30
execute as @e at @s on attacker if entity @s[scores={axe=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{axe_tag:1b}}}}] if data entity @s SelectedItem.components.minecraft:trim{"material":"minecraft:iron"}.material run effect give @s minecraft:resistance 2 0

execute as @e at @s on attacker if entity @s[scores={axe=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{axe_tag:1b}}}}] if data entity @s SelectedItem.components.minecraft:trim{"material":"minecraft:gold"}.material run particle dust_color_transition{from_color:[1.0,0.84,0.0],to_color:[1.0,0.64,0.0],scale:3} ~0.5 ~1.5 ~0.5 -1 -1 -1 0.1 10
execute as @e at @s on attacker if entity @s[scores={axe=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{axe_tag:1b}}}}] if data entity @s SelectedItem.components.minecraft:trim{"material":"minecraft:gold"}.material run damage @e[distance=..1,limit=1] 2 in_fire

execute as @e at @s on attacker if entity @s[scores={axe=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{axe_tag:1b}}}}] if data entity @s SelectedItem.components.minecraft:trim{"material":"minecraft:quartz"}.material run particle sweep_attack ~0.2 ~1.2 ~0.2 -0.4 -0.4 -0.4 0.1 10
execute as @e at @s on attacker if entity @s[scores={axe=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{axe_tag:1b}}}}] if data entity @s SelectedItem.components.minecraft:trim{"material":"minecraft:quartz"}.material run effect give @e[distance=..1,limit=1] minecraft:wither 2 2 true

execute as @e at @s on attacker if entity @s[scores={axe=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{axe_tag:1b}}}}] if data entity @s SelectedItem.components.minecraft:trim{"material":"minecraft:netherite"}.material run particle squid_ink ~0.2 ~1.2 ~0.2 -0.4 -0.4 -0.4 0.2 10
execute as @e at @s on attacker if entity @s[scores={axe=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{axe_tag:1b}}}}] if data entity @s SelectedItem.components.minecraft:trim{"material":"minecraft:netherite"}.material run effect give @e[distance=..1,limit=1] minecraft:darkness 5 5 true

execute as @e at @s on attacker if entity @s[scores={axe=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{axe_tag:1b}}}}] if data entity @s SelectedItem.components.minecraft:trim{"material":"minecraft:redstone"}.material run particle dust_pillar{block_state:{Name:redstone_block}} ~0.5 ~1.5 ~0.5 -1 -1 -1 0.1 30
execute as @e at @s on attacker if entity @s[scores={axe=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{axe_tag:1b}}}}] if data entity @s SelectedItem.components.minecraft:trim{"material":"minecraft:redstone"}.material run effect give @s instant_health 1 0 
...
execute as @e at @s on attacker if entity @s[scores={axe=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{axe_tag:1b}}}}] if data entity @s SelectedItem.components.minecraft:trim{"material":"minecraft:copper"}.material run effect give @e[distance=..1,limit=1] minecraft:slowness 1 5 true
...
execute as @e at @s on attacker if entity @s[scores={axe=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{axe_tag:1b}}}}] if data entity @s SelectedItem.components.minecraft:trim{"material":"minecraft:emerald"}.material run effect give @e[distance=..1,limit=1] minecraft:speed 2 2 true

execute as @e at @s on attacker if entity @s[scores={axe=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{axe_tag:1b}}}}] if data entity @s SelectedItem.components.minecraft:trim{"material":"minecraft:lapis"}.material run particle ominous_spawning ~0.2 ~1.2 ~0.2 -0.4 -0.4 -0.4 0 10
execute as @e at @s on attacker if entity @s[scores={axe=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{axe_tag:1b}}}}] if data entity @s SelectedItem.components.minecraft:trim{"material":"minecraft:lapis"}.material run particle enchant ~0.2 ~1.2 ~0.2 -0.4 -0.4 -0.4 0 10
...
execute as @e at @s on attacker if entity @s[scores={axe=0..},nbt={SelectedItem:{components:{"minecraft:custom_data":{axe_tag:1b}}}}] if data entity @s SelectedItem.components.minecraft:trim{"material":"minecraft:amethyst"}.material run data merge entity @e[distance=..1,limit=1,] {Motion:[0d,0.4d,0d]}
