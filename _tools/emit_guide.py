...
魔化值不显示在侧边栏，而是屏幕下方那条进度条，与利维坦、熔火之锤的蓄力条共用同一个位置（蓄力时蓄力条优先，松手后自己回来）。</p>
...
<div class="note"><b>什么算「圣器」。</b>手里握着下列任何一件即可：<b>驱魔图腾</b>、<b>驱魔圣水</b>、<b>圣水</b>、<b>天启星</b>、<b>替死人偶</b>，
或任何加过<b>神圣分支</b>的武器（丢神圣唱片给武器）。握着圣器时魔化会缓慢消退；
但魔化一旦到 91 以上，圣器<b>会灼手</b>。</div>
<div class="sys">
...
<tbody>
<tr><td><b>熬过去</b></td><td>魔化归零，获得<b>圣痕</b> 3 分钟：力量 II、抗性提升 I、生命恢复 I、防火、伤害吸收 II；期间<b>沾不上任何魔化</b>，且 6 格内的空缺者会被自动驱出——本人就是一场行走的仪式。</td></tr>
...
<div><h3>两条解约途径</h3><p class="how">逆圣化，或在燃着的图腾旁毁约</p><p><b>逆圣化</b>会把污染连同柱位一起烧掉。
